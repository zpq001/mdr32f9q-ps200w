    ...
    if (event->isAutoRepeat() == false)
    {
        switch(event->key())
        {
            ...
            case Qt::Key_Backspace:
                keyDriver1->keyPress(APP_KEY_ESC);
                break;
            case Qt::Key_Left:
                keyDriver1->keyPress(APP_KEY_LEFT);
                break;
            case Qt::Key_Right:
                keyDriver1->keyPress(APP_KEY_RIGHT);
                break;
            case Qt::Key_Return:
            case Qt::Key_Space:
                keyDriver1->keyPress(APP_KEY_OK);
                break;
            default:
...
bool MainWindow::on_keyRelease(QKeyEvent *event)
{
    ...
    if (event->isAutoRepeat() == false)
    {
        switch(event->key())
        {
            case Qt::Key_Escape:
            case Qt::Key_Backspace:
                keyDriver1->keyRelease(APP_KEY_ESC);
                break;
            case Qt::Key_Left:
                keyDriver1->keyRelease(APP_KEY_LEFT);
                break;
            case Qt::Key_Right:
                keyDriver1->keyRelease(APP_KEY_RIGHT);
                break;
            case Qt::Key_Return:
            case Qt::Key_Space:
                keyDriver1->keyRelease(APP_KEY_OK);
                break;
            default:
                eventIsHandled = false;
        }
